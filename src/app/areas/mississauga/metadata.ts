...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: generateCanonicalUrl('/areas/mississauga'),
  },
  openGraph: {
    ...
    url: generateCanonicalUrl('/areas/mississauga'),
  ...
  keywords: [
    ...
    'Port Credit appliance service', 
    'Erin Mills appliance repair',
    'same day appliance repair Mississauga',
    'Square One area appliance service'
  ]
}; 