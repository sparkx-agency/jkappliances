...
const benefits = [
    ...
    description: "Factory-trained specialists certified to repair all major Dryer brands.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
    ...
    description: "Fast response for Dryer emergencies when you need it most.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
...
const faqs = [
    {
      question: "How much does it typically cost to repair a Dryer?",
    answer: "Dryer repair costs typically range from $150 to $400 depending on the issue, parts required, and model. We provide a detailed estimate before starting any work so you know exactly what to expect."
    },
    {
      question: "How long should a Dryer last?",
    answer: "Most modern Dryers have a lifespan of 10-15 years with proper maintenance. Regular service and timely repairs can extend the life of your appliance significantly."
    },
    {
      question: "Is it worth repairing an old Dryer?",
    answer: "If your Dryer is less than 8 years old, repair is usually more cost-effective than replacement. For older units, we'll provide an honest assessment of whether repair or replacement makes more sense economically."
    },
    {
      question: "How quickly can you repair my Dryer?",
    answer: "In most cases, we can complete Dryer repairs on the same day as diagnosis. For more complex issues requiring special parts, it may take 1-2 additional days to source parts and complete the repair."
    },
    {
      question: "Do you offer any maintenance plans for Dryers?",
    answer: "Yes, we offer annual maintenance plans that include cleaning coils, checking refrigerant levels, inspecting door seals, and other preventative measures to keep your Dryer running efficiently."
  }
];
...
export default function DryerRepairPage() {
  ...
  return (
    <div className="bg-[#f5f5f7] pt-24  ">
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Our skilled technicians can diagnose and repair all Dryer issues, from simple fixes to complex system failures.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Our experienced technicians, quality parts, and exceptional service make us the smart choice for Dryer repair.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-[#f5f5f7]">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Discover why customers consistently choose our Dryer repair services.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            >
              ...
              <p className="text-[#424245] mb-4 leading-relaxed">
                JK Appliances has built a large customer base with hundreds of successfully repaired Dryers. Our technicians use the latest equipment, firm tools, and methods that have been proven effective over years of service.
              </p>
              <p className="text-[#424245] mb-4 leading-relaxed">
                Before fixing any malfunction, we perform a comprehensive diagnostic to detect all possible issues with your Dryer. When replacement parts are needed, we use only original manufacturer components to ensure lasting performance.
              </p>
              <p className="text-[#424245] leading-relaxed">
            ...
            >
              ...
              <p className="text-[#424245] mb-4 leading-relaxed">
                In today's fast-paced world, time is precious. When it comes to Dryer repairs, every moment counts—especially when water is leaking onto your floor or food is at risk of spoiling.
              </p>
              <p className="text-[#424245] mb-4 leading-relaxed">
              ...
              <p className="text-[#424245] leading-relaxed">
                Contact us as soon as you notice any signs of Dryer malfunction. The sooner we can address the issue, the more likely we can prevent further damage and expense.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* Brands Section */}
      <BrandsSliderSection
        title="Top Dryer Brands We Fix"
        subtitle="Our technicians are certified to repair all major dryer brands and models."
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Get answers to common questions about Dryer repair services.
            </p>
          </motion.div>
