...
export default function InstallationServicesPage() {
  ...
  return (
    <div className="bg-[#f5f5f7] pt-24 pb-20">
      ...
      {/* Brands Section */}
      <BrandsSliderSection
        title="Top Appliance Brands We Install"
        subtitle="Our technicians are certified to install all major appliance brands and models."
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          >
            <h2 className="text-4xl font-semibold text-[#1d1d1f] mb-6">
            Ready to Install Your Appliance?
            </h2>
