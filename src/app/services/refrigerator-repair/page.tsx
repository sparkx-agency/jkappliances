...
const problems = [
    ...
    },
    {
      id: "water-leaking",
    title: "Water Leaking",
    description: "Water puddles inside or around your refrigerator requiring immediate attention.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
...
const benefits = [
    ...
    description: "Factory-trained specialists certified to repair all major refrigerator brands.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
    ...
    description: "Fast response for refrigerator emergencies when you need it most.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
...
const faqs = [
    {
      question: "How much does it typically cost to repair a refrigerator?",
    answer: "Refrigerator repair costs typically range from $150 to $400 depending on the issue, parts required, and model. We provide a detailed estimate before starting any work so you know exactly what to expect."
    },
    {
      question: "How long should a refrigerator last?",
    answer: "Most modern refrigerators have a lifespan of 10-15 years with proper maintenance. Regular service and timely repairs can extend the life of your appliance significantly."
    },
    {
      question: "Is it worth repairing an old refrigerator?",
    answer: "If your refrigerator is less than 8 years old, repair is usually more cost-effective than replacement. For older units, we'll provide an honest assessment of whether repair or replacement makes more sense economically."
    },
    {
      question: "How quickly can you repair my refrigerator?",
    answer: "In most cases, we can complete refrigerator repairs on the same day as diagnosis. For more complex issues requiring special parts, it may take 1-2 additional days to source parts and complete the repair."
    },
    {
      question: "Do you offer any maintenance plans for refrigerators?",
    answer: "Yes, we offer annual maintenance plans that include cleaning coils, checking refrigerant levels, inspecting door seals, and other preventative measures to keep your refrigerator running efficiently."
  }
];
    ...
    <div className="bg-[#f5f5f7] pt-24 pb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-semibold text-[#1d1d1f] mb-6 tracking-tight">
                Refrigerator<br />Repair Service
              </h1>
            ...
            >
              <div className="aspect-[4/3] rounded-3xl overflow-hidden">
                <Image
                  src="/images/services/refrigerator-repair.jpg"
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          >
            <h2 className="text-4xl font-semibold text-[#1d1d1f] mb-6">
              Expert Refrigerator Repair Services
            </h2>
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto leading-relaxed">
              Your refrigerator is an essential appliance in your modern kitchen. We understand how disruptive a malfunctioning fridge can be to your daily life, which is why our expert technicians provide fast, reliable repair services for all major brands and models.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            >
              ...
              <p className="text-[#424245] mb-4 leading-relaxed">
                Today's refrigerators are designed to last 5-10 years with proper care, but even the highest quality appliances can develop issues due to improper maintenance or factory defects. When problems arise, our experienced technicians can diagnose and fix your refrigerator quickly and efficiently.
              </p>
              <p className="text-[#424245] mb-4 leading-relaxed">
                At JK Appliances, we use the latest equipment and proven repair methods to ensure your refrigerator works like new. Our comprehensive diagnostic process identifies both immediate issues and potential future problems, allowing us to provide a complete solution.
              </p>
            ...
            >
              <div className="aspect-video rounded-2xl overflow-hidden">
                <Image 
                  src="/images/services/refrigerator-technician.jpg" 
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Our skilled technicians can diagnose and repair all refrigerator issues, from simple fixes to complex system failures.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-[#f5f5f7]">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Our experienced technicians are qualified to repair all styles and configurations of refrigerators.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-xl font-semibold text-[#1d1d1f] mb-4">Free-standing Refrigerators</h3>
              ...
              <Image 
                ...
                alt="Free-standing refrigerator"
                width={400}
                height={300}
            ...
            <motion.div
              ...
              className="bg-white rounded-3xl p-8 hover:shadow-lg transition-all"
            >
              <h3 className="text-xl font-semibold text-[#1d1d1f] mb-4">Built-in Refrigerators</h3>
              <p className="text-[#424245] mb-4">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Our experienced technicians, quality parts, and exceptional service make us the smart choice for refrigerator repair.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-[#f5f5f7]">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Discover why customers consistently choose our refrigerator repair services.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            >
              ...
              <p className="text-[#424245] mb-4 leading-relaxed">
                JK Appliances has built a large customer base with hundreds of successfully repaired refrigerators. Our technicians use the latest equipment, firm tools, and methods that have been proven effective over years of service.
              </p>
              <p className="text-[#424245] mb-4 leading-relaxed">
                Before fixing any malfunction, we perform a comprehensive diagnostic to detect all possible issues with your refrigerator. When replacement parts are needed, we use only original manufacturer components to ensure lasting performance.
              </p>
              <p className="text-[#424245] leading-relaxed">
            ...
            >
              ...
              <p className="text-[#424245] mb-4 leading-relaxed">
                In today's fast-paced world, time is precious. When it comes to refrigerator repairs, every moment counts—especially when water is leaking onto your floor or food is at risk of spoiling.
              </p>
              <p className="text-[#424245] mb-4 leading-relaxed">
              ...
              <p className="text-[#424245] leading-relaxed">
                Contact us as soon as you notice any signs of refrigerator malfunction. The sooner we can address the issue, the more likely we can prevent further damage and expense.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Our technicians are certified to repair all major refrigerator brands and models.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-[#f5f5f7]">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            <h2 className="text-4xl font-semibold text-[#1d1d1f] mb-6">
              Common Refrigerator Issues We Resolve
            </h2>
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Our technicians can diagnose and fix all of these common refrigerator problems.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{delay: 0.15}} className="bg-white p-4 rounded-2xl">
              <span className="text-[#424245]">Refrigerator is too cold</span>
            </motion.div>
            ...
            <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{delay: 0.35}} className="bg-white p-4 rounded-2xl">
              <span className="text-[#424245]">Refrigerator constantly runs</span>
            </motion.div>
            <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{delay: 0.4}} className="bg-white p-4 rounded-2xl">
              <span className="text-[#424245]">Refrigerator leaking water</span>
            </motion.div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Get answers to common questions about refrigerator repair services.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-10 max-w-3xl mx-auto">
              Our expert technicians are standing by to provide fast, reliable refrigerator repair services.
            </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Expert refrigerator repair services in Toronto and GTA. Fast, reliable repairs for all major brands including Samsung, LG, Whirlpool, and more.",
