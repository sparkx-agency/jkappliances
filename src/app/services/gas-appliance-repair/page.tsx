      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Our experienced technicians, quality parts, and exceptional service make us the smart choice for gas appliance repair.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            ...
            <p className="text-lg text-[#86868b] max-w-3xl mx-auto">
              Our technicians are certified to repair all major gas appliance brands and models.
            </p>
          </motion.div>
