...
const brandsData = [
  ...
  },
  {
    ...
    description: 'Premium repair services for all Dacor luxury appliances.',
    categories: ['refrigerators', 'ovens', 'ranges', 'cooktops'],
    popular: false,
  },
  {
    id: 'panasonic',
    ...
    description: 'Professional repair services for all Panasonic home appliances.',
    categories: ['refrigerators', 'microwaves', 'air-conditioners'],
    popular: false,
  },
  {
    id: 'viking',
    ...
    description: 'Expert repairs for high-end Viking professional kitchen appliances.',
    categories: ['refrigerators', 'ovens', 'ranges', 'cooktops'],
    popular: false,
  },
  {
    ...
    description: 'Reliable repair solutions for all Moffat appliance models.',
    categories: ['ovens', 'ranges', 'cooktops'],
    popular: false,
  },
  {
    ...
    description: 'Quality repairs for luxury Fulgor Milano kitchen appliances.',
    categories: ['dishwashers', 'ovens', 'ranges', 'cooktops'],
    popular: false,
  },
  {
    id: 'gaggenau',
    ...
    description: 'Specialized repair services for premium Gaggenau appliances.',
    categories: ['refrigerators', 'ovens', 'cooktops', 'dishwashers'],
    popular: false,
  },
  {
    id: 'inglis',
    ...
    description: 'Affordable repair solutions for all Inglis appliance models.',
  ...
  },
  {
    ...
    description: 'Expert repair services for all JennAir luxury appliances.',
    categories: ['refrigerators', 'ovens', 'ranges', 'cooktops'],
    popular: false,
  },
  {
    ...
    description: 'Premium repair services for Liebherr refrigeration appliances.',
    categories: ['refrigerators', 'freezers'],
    popular: false,
  },
  {
    ...
    description: 'Comprehensive repair services for Fisher & Paykel appliances.',
    categories: ['refrigerators', 'washers', 'dryers', 'dishwashers'],
    popular: false,
  },
];
